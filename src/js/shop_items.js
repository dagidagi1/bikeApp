...
document.addEventListener('click', (e) => {
  if (e.target.id.slice(0, 10) == 'deleteBtn') {
    deleteRow(e.target.id.slice(10));
  }
});
...
function buildElement(iId, imgSrc, iName, iPrice, iType, hasImg) {
  ...
  editBtn.setAttribute('style', 'color: var(--bs-table-striped-color);background: var(--bs-table-bg);border-style: hidden;');
  ...
  deleteBtn.setAttribute('style', 'color: var(--bs-table-striped-color);background: var(--bs-table-bg);border-style: hidden;');
